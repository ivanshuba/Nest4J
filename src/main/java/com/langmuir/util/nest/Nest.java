...
import static com.langmuir.util.nest.util.IOUtils.debug;
...
public class Nest {
  ...
  public List<List<Placement>> startNest() {
    ...
    double xbinmax = binPolygon.getSegment(0).x;  // get.(0) = prende il primo segmento dei 4 (coordinate del primo vertice), se si assume che la superficie sia rettangolare
